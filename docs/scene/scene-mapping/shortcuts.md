---
title: "Scene Mapping Shortcuts"
icon: "⌨️"
created: 2026-02-16
updated: 2026-04-27
---

# Scene Mapping Shortcuts

Keyboard and mouse shortcuts for the in-scene `MeshTool` — used when editing `MeshComponent` / `PolygonMesh` geometry. Not the legacy Hammer keybinds.
...
| Snap To Vertex | B |
| Soft Normals | J |
| Open Clipping Tool | Shift + X |
| Mirror Tool | Shift + F |
| Vertex Weld UVs | Ctrl + F |
| Apply Hotspot | Alt + H |
| Apply Hotspot Per Face | Alt + T |
...
| Toggle Global Space | T |
| Cycle Viewmode | Ctrl + Space |
