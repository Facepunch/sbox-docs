...
![The Thumbnails/Videos generated by an AssetPreview are also used when uploading Assets to sbox.game](./images/the-thumbnails-videos-generated-by-an-assetpreview-are-also.png)
...
public class PreviewMyModelResource : AssetPreview
{
	...
	public override Task InitializeAsset()
	{
		...
		using ( Scene.Push() )
		{
			...
			var modelRenderer = PrimaryObject.Components.Create<SkinnedModelRenderer>();
...
[How the Thumbnail and Preview appear
 1266x338](./images/thumbnail-and-preview-demo.mp4)
...
public class PreviewMyTextureResource : AssetPreview
{
	...
	public override Task InitializeAsset()
	{
		...
		using ( Scene.Push() )
		{
			...
			var spriteRenderer = PrimaryObject.Components.Create<SpriteRenderer>();
...
![How the Thumbnail and Preview appear](./images/how-the-thumbnail-and-preview-appear.png)
