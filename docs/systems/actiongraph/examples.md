...
![Uses For Each on the list of child objects, firing the Body signal on each child.](./images/uses-for-each-on-the-list-of-child-objects-firing-the-body-s.png)
