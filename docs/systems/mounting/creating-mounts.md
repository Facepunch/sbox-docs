...
updated: 2026-04-25
sources:
  - engine/Mounting/Sandbox.Mounting/MountHost/
  - engine/Mounting/Sandbox.Mounting/MountedAsset/
...
- [External Game Mounting](index.md) — overview of the existing GoldSrc/NS2/Quake mounts
- [Mounting Internals](../../engine-internals/mounting.md) — engine-developer deep dive
