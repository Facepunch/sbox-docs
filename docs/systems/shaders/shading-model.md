...
Consumes your [Material](material.md) and shades the output with lighting, atmospheric, and deals with everything needed to show specific stages of rendering if [Debug Views](modes.md) are enabled.
